...
#### The goal is to deliver:
  ...
  🛠️ A modular analytics pipeline designed for extension into full tournament prediction models
  
  🧠 A portfolio-ready demonstration of statistical thinking, data cleaning, and dashboarding skills in a sport-specific context
...
- Top player metrics and highlights
- Lay the foundation for an eventual bracketology prediction model
- Practice and demonstrate data collection, feature engineering, and sports-specific stat interpretation
...
├── tableau/                # Tableau workbook + exported visuals
├── scripts/                # Scraping and data prep tools
├── assets/                 # Team logos, player headshots
├── README.md               # This file
